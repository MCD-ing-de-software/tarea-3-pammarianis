...
class TestStatisticsUtils(unittest.TestCase):
    ...
    def test_moving_average_basic_case(self):
        ...
        # Crear una lista
        lista = [1, 2, 3, 4]
        # Llamar a moving_average
        utils = StatisticsUtils()
        result = utils.moving_average(lista, window=2)
        # Valores esperados
        expected = np.array([1.5, 2.5, 3.5])
        # Comparar usando numpy.testing.assert_allclose()
        npt.assert_allclose(result, expected, rtol=1e-7, atol=1e-7)
    ...
    def test_moving_average_only_accepts_1d_sequences(self):
        ...
        """
        # Crear una secuencia bidimensional
        seq_2d = [[1, 2], [3, 4]]
        utils = StatisticsUtils()  
        # Verificar ValueError para secuencia multidimensional
        with self.assertRaises(ValueError):
            utils.moving_average(seq_2d, window=2)
    ...
    def test_zscore_raises_for_zero_std(self):
        ...
        """
        # Crear una lista con todos los valores iguales
        lista = [5, 5, 5]
        utils = StatisticsUtils()
        # Verificar ValueError para desviación estándar cero
        with self.assertRaises(ValueError):
            utils.zscore(lista)
    ...
    def test_min_max_scale_maps_to_zero_one_range(self):
        ...
        result = utils.min_max_scale(lista)
    ...
    def test_min_max_scale_raises_for_constant_values(self):
        ...
        lista = [3, 3, 3]
        utils = StatisticsUtils()
        # Verificar ValueError para secuencia constante
        with self.assertRaises(ValueError):
